import { jobLogService } from '@/app/services/jobLogService';
import { demoBackendService } from '@/demo/services/demoBackendService';
import { JobLog, JobLogFormData } from '@/shared/types/business';
